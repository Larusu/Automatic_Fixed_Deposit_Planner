...
public class DepositPlan 
{
    ...
    public DepositPlan(int user_id, int goal_id, double principal_amount, int duration_value, DurationUnit duration_unit,
                   Frequency compounding_frequency, String start_date) 
    {
        this.userId = user_id;
        this.goalId = goal_id;
    ...
    public DepositPlan(int user_id, double principal_amount, int duration_value, DurationUnit duration_unit,
                   Frequency compounding_frequency, String start_date) 
    {
        this.userId = user_id;
        this.principalAmount = principal_amount;
